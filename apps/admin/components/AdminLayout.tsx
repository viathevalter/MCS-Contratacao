  ...
  return (
    <div className="min-h-screen bg-slate-100 flex">
      ...
      <div className="flex-1 ml-64 flex flex-col min-h-screen">
        {/* Topbar */}
        <header className="h-16 bg-white shadow-sm flex justify-between items-center px-8 z-10 sticky top-0">
          <h2 className="text-xl font-semibold text-slate-800">Portal de Candidatos</h2>
