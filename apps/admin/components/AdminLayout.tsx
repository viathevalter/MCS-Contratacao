    ...
    <div className="min-h-screen bg-slate-100 flex relative">
      ...
      `}>
        ...
        <div className="p-4 border-t border-slate-800">
          ...
          <a href="https://wolterscontratacao.com/candidatar" target="_blank" rel="noopener noreferrer" className="flex items-center text-sm text-slate-400 hover:text-white transition-colors">
