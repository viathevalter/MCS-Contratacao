  ...
  return (
    <main className="min-h-screen bg-slate-50 font-sans text-slate-900">
          ...
          <div className="grid gap-12 md:grid-cols-2 md:items-center">
            ...
            <div>
              ...
              <div className="mt-6 space-y-6 text-lg text-slate-600 leading-relaxed">
                <p dangerouslySetInnerHTML={{ __html: t.raw('about.p1') }} />
                <p>
                  {t('about.p2')}
                </p>
              </div>
      ...
      <section id="servicos" className="py-20 bg-slate-50">
        <div className="mx-auto max-w-7xl px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-slate-900 md:text-4xl">{t('services.title')}</h2>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {[
              {
                title: t('services.items.welding.title'),
                desc: t('services.items.welding.desc'),
                icon: (
              ...
              {
                title: t('services.items.boilermaking.title'),
                desc: t('services.items.boilermaking.desc'),
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
              ...
              },
              {
                ...
                desc: t('services.items.fabrication.desc'),
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
              ...
              {
                title: t('services.items.mechanics.title'),
                desc: t('services.items.mechanics.desc'),
                icon: (
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
      ...
      <section id="internacional" className="relative bg-[#0c4a6e] py-20 text-white">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10 text-center">
          <h2 className="text-3xl font-bold md:text-4xl">{t('international.title')}</h2>
          <p className="mt-4 text-xl text-blue-100 max-w-3xl mx-auto">
            {t('international.description')}
          </p>
          <div className="mt-10 flex flex-wrap justify-center gap-6">
            {[t('international.countries.spain'), t('international.countries.belgium'), t('international.countries.italy')].map((country) => (
