...
// Note: Radix UI Slot/CVA are standard but sticking to simple prop-based for now to match Admin's implementation speed 
// unless I install them. Admin uses manual classes. I will use manual classes to minimize dependencies, or simple CVA if I had it.
// Actually, I'll port the exact code from Admin but adapted for Next.js (no major changes needed as it's just React).
...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    ({ className, variant = "primary", size = "md", fullWidth = false, isLoading = false, leftIcon, rightIcon, children, disabled, ...props }, ref) => {
        ...
        const variants = {
            primary: "bg-[#FF6B00] hover:bg-[#e66000] text-white shadow-sm focus:ring-orange-500 border border-transparent", // Using Landing CTA color directly
            secondary: "bg-white hover:bg-slate-50 text-slate-700 border border-slate-300 focus:ring-blue-500",
